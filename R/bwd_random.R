...
#' @export
BWDRandom <- R6::R6Class("BWDRandom",
                         public = list(
                           ...
                           set_alpha = function(N) {
                             ...
                             self$alpha <- -1 # Indicator for "random mode"
                           },
                           ...
                           assign_next = function(x) {
                             ...
                             if (runif(1) < p_i) {
                               ...
                               val <- self$value_minus
                               assignment <- -1
                             }

                             self$w_i <- self$w_i + val * x
                             self$iterations <- self$iterations + 1

                             return(as.integer((assignment + 1) / 2))
                           },
                           ...
                           reset = function() {
                             self$w_i <- numeric(self$D)
                             self$alpha <- log(2 * self$N / self$delta) * min(1 / self$q, 9.32)
                             self$iterations <- 0
                           }
                         ),
